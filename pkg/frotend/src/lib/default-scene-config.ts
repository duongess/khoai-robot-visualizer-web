...
export const DEFAULT_SCENE_CONFIG: SceneConfig = {
	workspace: { minX: 0, maxX: 6, minY: 0, maxY: 3.2, coordinate_system_version: 2 },
  ...
  gantry: { rail_y: 3.1, carriage_x: 1.5, gripper_y: 2.8, min_x: 0.275, max_x: 5.725, min_y: 0.65, max_y: 3.04, initial_grip_force: 0, minimum_grip_force: 0, maximum_grip_force: 20 },
